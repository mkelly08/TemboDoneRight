...
export const About = () => (
  ...
  <Row className='pt-5' fluid>
    <Col sm className='my-auto' sm fluid>
      <Row className="sectionContent">
        The Tembo Group is a social impact advisory firm.
            ...
            To learn more about our name, 
            <span className="textBack mt-5"><NavLink to="/home/whyus">ClICK HERE.</NavLink></span>
            <br/><br/>
      </Row>
    </Col>
    ...
    <Col className='text-center' sm fluid>
      <img src={elephant} className='img-fluid my-auto' fluid/>
    </Col>
  </Row>
